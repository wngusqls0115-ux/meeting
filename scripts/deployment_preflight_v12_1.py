...
required = [
    ...
    ROOT/"render.yaml",
    ROOT/"LOCKED_DEVELOPMENT_CONTRACT_V10.md",
    ROOT/"PACKAGE_VERSION.txt",
]

print("=== V12.1 DEPLOYMENT PREFLIGHT ===")
print("ROOT =", ROOT)

missing = [str(p.relative_to(ROOT)) for p in required if not p.exists()]
if missing:
    print("FAIL missing_files:", ", ".join(missing))
    sys.exit(2)

version = (ROOT/"PACKAGE_VERSION.txt").read_text(encoding="utf-8").strip()
...
checks = {
    "package_v12_1": "MEETING_APP_PACKAGE=V12.1" in version,
...
print("\nFile fingerprints:")
for rel in ["app.py", "static/app.js", "static/index.html", "scripts/check_locked_features.py"]:
    p = ROOT/rel
